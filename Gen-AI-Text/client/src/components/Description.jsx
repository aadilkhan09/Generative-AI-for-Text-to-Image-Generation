...
const Description = () => {
  return (
    ...
    className='flex flex-col items-center justify-center my-24 p-6 md:px-28'>
      <h1 className='text-3xl sm:text-4xl'>Generated AI Image</h1>
      <p className='text-gray-500 mb-8'>Bring Creativity Vision to life</p>
      <div className='flex flex-col gap-5 md:gap-14 md:flex-row items-center'>
        ...
        <div>
          ...
          <p className='text-gray-600'>Effortlessly bring your ideas to life with out free AI image generator. Transform your text into stunning visuals in seconds. Imagine, describe, and see your vision come to life instantly.</p>
